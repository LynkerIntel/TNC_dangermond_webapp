...
# Provide AWS Account Number, S3 bucket name, Terraform state S3 bucket name, ECR repo name,
#  AWS region, and AWS profile as arguments to the script.
# Example: source sh/build_and_push_docker_image.sh 123456789 ecr-repo-name aws-region aws-profile
